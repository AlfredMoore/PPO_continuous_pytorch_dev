...
def save_model_param(args, network, optimizer, current_step, path):
...
if __name__ == '__main__':
    ...
    # env_name = ['BipedalWalker-v3', 'HalfCheetah-v4', 'Hopper-v2', 'Walker2d-v2']
    # env_index = 1
    # main(args, env_name=env_name[env_index], number=1, seed=10)
    
    main(args, env_name='BipedalWalker-v3', number=1, seed=10)
